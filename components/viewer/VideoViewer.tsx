...
const VideoViewer: FC<VideoViewerProps> = ({ id, data }) => {
  ...
  const player = useVideoPlayer(data.filePath, (player) => {
    player.loop = true
    player.play()
    player.muted = true
  })
  ...
  return (
    <View className="relative flex-1">
      ...
      >
        <View className="flex h-14 w-[30%] items-center justify-center rounded-full bg-white">
